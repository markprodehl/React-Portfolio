                ...
                <ScrollAnimation animateIn="fadeIn" animateOut='fadeOut'>
                    <div className="row container mx-auto myBox">
                        <div  className="col-lg-6 text-center pt-4">
                            ...
                            <div className="d-flex justify-content-center mt-4">
                                <a className="myBtn text-center" href="https://the-food-logger.herokuapp.com/">VIEW APP</a>
                            </div>
                        </div>
                        <div className="col-lg-6">
                ...
                <ScrollAnimation animateIn="fadeIn" animateOut='fadeOut'>
                    <div className="row container mx-auto myBox">
                        <div  className="col-lg-6 text-center pt-4">
                            ...
                            <div className="d-flex justify-content-center mt-4">
                                <a className="myBtn text-center" href="https://markprodehl.github.io/Memory-Game/">VIEW APP</a>
                            </div>
                        </div>
                        <div className="col-lg-6">
