                    ...
                    <div class="row container mx-auto myBox">
                        ...
                        <div class="col-lg-6 text-center pt-4">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a class="myBtn text-center" href="https://thirty-day-challenge.herokuapp.com/login">VIEW APP</a>
                            </div>
                        </div>
                    </div>
                </ScrollAnimation>        
                <ScrollAnimation animateIn="fadeIn" animateOut='fadeOut'>
                    <div class="row container mx-auto myBox">
                        <div  class="col-lg-6 text-center pt-4">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a class="myBtn text-center" href="https://the-food-logger.herokuapp.com/">VIEW APP</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <ScrollAnimation animateIn="fadeIn" animateOut='fadeOut'>
                    <div class="row container mx-auto myBox">
                        ...
                        <div  class="col-lg-6 text-center pt-4">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a class="myBtn text-center" href="https://offlinebudget-tracker.herokuapp.com/">VIEW APP</a>
                            </div>
                        </div>
                    </div>
                </ScrollAnimation>   
                <ScrollAnimation animateIn="fadeIn" animateOut='fadeOut'>
                    <div class="row container mx-auto myBox">
                        <div  class="col-lg-6 text-center pt-4">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a class="myBtn text-center" href="https://markprodehl.github.io/Memory-Game/">VIEW APP</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
