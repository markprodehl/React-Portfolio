...
function Footer(props) {
    return (
        ...
        <div className="d-flex justify-content-center mt-5 container fixed-bottom">
            ...
            <a className="socialLinks text-center" href="https://drive.google.com/file/d/1UY1TYwuxbtROBCgRKgsPLZ5R8q4y0n1r/view?usp=sharing" target="_blank" rel="noopener noreferrer"><i className="far fa-file fa-3x"></i></a>
        </div>
    )
}
